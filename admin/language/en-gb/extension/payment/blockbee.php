...
$_['text_blockbee'] = '<a target="_BLANK" href="https://blockbee.io/"><img src="' . HTTPS_SERVER . 'view/image/payment/blockbee.png" alt="blockbee" title="blockbee" style="border: 1px solid #EEEEEE; height:35px" /></a>';
$_['text_connect_blockbee'] = 'This module allows you to accept BlockBee Payments securely.';
$_['text_blockbee_image'] = '<a target="_BLANK" href="https://blockbee.io/"><img src="' . HTTPS_SERVER . 'view/image/payment/blockbee.png" alt="blockbee" title="blockbee" class="img-fluid" style="height:60px; margin-left:12px" /></a>';
